...
class Calculator:
    def __init__(self,master):
        ...
        master.config(bg='gray')#establish the background
...
root=Tk()#create an instace of the 'TK' class
calculator=Calculator(root)
root.mainloop()#This line starts the main event loop of the GUI. It continuously listens for events (such as button clicks or text input) and updates the GUI accordingly.
